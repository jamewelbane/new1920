                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Cancelled Ordes</h4>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    if ($cancellationExists) {
                                                        $cancellationData = $resultCancellation->fetch_assoc();
                                                        $cancelledAt = date('d M Y', strtotime($cancellationData['date']));
                                                    } else {
                                                        $cancelledAt = null; // Or handle the case where there is no cancellation
                                                    }
                                                    ...
                                                    if (!$cancellationExists) {
                                                        ...
                                                        echo "<label class='badge badge-danger'>Cancelled</label>";
                                                    }
