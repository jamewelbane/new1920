...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $body = "This email is to confirm your request for cancellation with transaction number: $txn. Your request has been approved and your money has been refunded.";
    // Fetch order list
    ...
    <p><strong>Refunded Amount: ' . $totalPriceFormatted .'</strong></p>
