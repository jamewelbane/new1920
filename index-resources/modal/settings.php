    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="changePasswordForm" action="index-resources/function/settings/change-password-process.php" method="post" style="display: none;">
                ...
                <!-- Update info form -->
                <form id="changeInfoForm" action="index-resources/function/settings/change-info-process.php" method="post" style="display: none;">
...
document.getElementById('backToSettingsBtn2').addEventListener('click', function() {
    ...
    document.getElementById('changePasswordForm').addEventListener('submit', function(event) {
        ...
        if (currentPassword.length > 0) {
            ...
            xhr.open('POST', 'index-resources/function/settings/change-password-process.php', true);
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('POST', 'index-resources/function/settings/change-info-process.php', true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
