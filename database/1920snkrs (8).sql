...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 07:20 PM
...
(47, 60434, 28, '37', 1, '2024-06-02 14:19:55');
...
--
ALTER TABLE `order_list`
  MODIFY `order_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `users`
  MODIFY `userid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60436;
