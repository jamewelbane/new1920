...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2024 at 12:26 AM
...
INSERT INTO `product_inventory` (`inventory_id`, `product_id`, `stock`, `out_of_stock_datetime`, `replenished_datetime`) VALUES
(1, 24, 5, NULL, NULL),
(2, 25, 2, NULL, NULL),
(3, 6, 3, NULL, NULL),
(4, 19, 3, NULL, NULL),
...
--
ALTER TABLE `users`
  MODIFY `userid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60433;
